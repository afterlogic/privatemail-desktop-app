<template>
  <div class="column full-height bg-white text-black">
    <div class="col-auto q-px-md q-pt-md">
      ...
      <q-chip icon-right="add">Afterlogic Support</q-chip>
      →
      <q-chip>me</q-chip>
      <q-chip icon-right="add">Nadine</q-chip>
      <div class="row items-center q-pa-md" style="clear: both;">
        <div class="col subject text-h4">RE: Extract Cloud - Call Summary</div>
        <div class="col-auto date">Jul 25, 13:07</div>
      </div>
      <q-separator />
    </div>
    <div class="col">
