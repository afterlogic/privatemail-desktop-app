    ...
    <q-list>
      ...
      <q-item tag="label">
        <q-item-section avatar>
          <q-radio v-model="bNoSignature" :val="true" color="primary" />
        </q-item-section>
        <q-item-section>
      ...
      <div style="display: flex">
        <q-item>
          <q-radio style="align-items: start" v-model="bNoSignature" :val="false" color="primary" />
        </q-item>

        <q-editor v-model="sSignature" ref="editor" height="200px" class="full-height q-mt-md q-mb-md"
                  :toolbar="editorToolbar"
                  :disable="bNoSignature"
                  :fonts="{
            arial: 'Arial',
